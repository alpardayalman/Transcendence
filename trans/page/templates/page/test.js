...
boundX = 40;
boundY = 20;
paddle1 = new Paddle("w", "s");
paddle2 = new Paddle("o", "l");

gamePlane = new Background(boundX + 1.8, boundY + 2.2, 0x7338A0);
backPlane = new Background(200, 100, 0x99ffff ^ 0x7338A0);
middleLine = new MiddleLine(0x000000, boundY);
